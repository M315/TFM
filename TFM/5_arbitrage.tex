...
We will use \cite{bjork_arbitrage} as a reference for this section,
...
\begin{definition}[Arbitrage]
    A self-financing portfolio $\theta(t)$ is an \textit{arbitrage} if one of the following conditions hold for time $t$:
    \begin{enumerate}
