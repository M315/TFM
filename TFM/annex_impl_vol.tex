...
\section{Implied Volatility Surface - Implementation Details}
\label{app:impl_vol}
...
% ----------------------------------
\subsection{Dividend yield calibration}
...
% ----------------------------------
\subsection{OTM composite construction}
...
% ----------------------------------
\subsection{Expiration selection}
